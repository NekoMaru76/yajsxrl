import type { XElement } from "./render.ts";

import type {
	ClassAttributes,
	PreactDOMAttributes
} from "preact/src/index";
import { SetState } from "./render.d.ts";
...
export namespace JSX {
	...
	export type ElementType<P = any> = ElementClass<P> | typeof XElement
	export type Element<P = any> = XElement<P>
	export interface ElementClass<P = any> extends Element<P> {
        new(props: P, children: any, setState: SetState): Element<P>
    }
